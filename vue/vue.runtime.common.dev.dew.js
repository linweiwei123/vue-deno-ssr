...
export function dew() {
  ...
  function createPatchFunction(backend) {
    ...
    function setScope(vnode) {
      ...
      if (
        isDef(i = activeInstance) && i !== vnode.context &&
  ...
  function baseSetAttr(el, key, value) {
    if (isFalsyAttrValue(value)) {
      ...
      /* istanbul ignore if */
      if (
        isIE && !isIE9 && el.tagName === "TEXTAREA" && key === "placeholder" &&
        value !== "" && !el.__ieph
      ) {
  ...
  function updateClass(oldVnode, vnode) {
    ...
    if (
      isUndef(data.staticClass) && isUndef(data.class) &&
      (isUndef(oldData) ||
  ...
  function enter(vnode, toggleDisplay) {
    ...
    if (!vnode.data.show) {
      ...
      mergeVNodeHook(vnode, "insert", function () {
        ...
        if (
          pendingNode && pendingNode.tag === vnode.tag &&
  ...
  var Transition = {
    ...
    render: function render(h) {
      ...
      if (
        oldChild && oldChild.data && !isSameChild(child, oldChild) &&
