import { dew as _npmHe1DewDew } from "https://dev.jspm.io/npm:he@1?dew";
import _stream from "https://dev.jspm.io/npm:@jspm/core@1/nodelibs/stream.js";
import { dew as _npmLodashDew } from "https://dev.jspm.io/npm:lodash.template@4?dew";
import _path from "https://dev.jspm.io/npm:@jspm/core@1/nodelibs/path.js";
import { dew as _npmSerializeJavascript2DewDew } from "https://dev.jspm.io/npm:serialize-javascript@2?dew";
import _vm from "https://dev.jspm.io/npm:@jspm/core@1/nodelibs/vm.js";
import { dew as _npmResolve1DewDew } from "https://dev.jspm.io/npm:resolve@1?dew";
import _empty from "https://dev.jspm.io/npm:@jspm/core@1/nodelibs/@empty.js";
import { dew as _npmSourceMapDew } from "https://dev.jspm.io/npm:source-map@0.5.6?dew";
import _process from "https://dev.jspm.io/npm:@jspm/core@1/nodelibs/process.js";
import _buffer from "https://dev.jspm.io/npm:@jspm/core@1/nodelibs/buffer.js";
var exports = {},
  _dewExec = false;
...
export function dew() {
  ...
  var he = _interopDefault(_npmHe1DewDew());
  /*  */
  ...
  function renderDOMProps(node) {
    ...
    for (var key in props) {
      if (key === "innerHTML") {
        ...
        if (
          isRenderableAttr(attr) && // avoid rendering double-bound props/attrs twice
  ...
  function getPropDefaultValue(vm, prop, key) {
    ...
    if (
      vm && vm.$options.propsData && vm.$options.propsData[key] === undefined &&
  ...
  var RenderStream =
    ...
    function (superclass) {
      ...
      RenderStream.prototype = Object.create(
    ...
    while (html) {
      ...
      if (!lastTag || !isPlainTextElement(lastTag)) {
        ...
        if (textEnd >= 0) {
          ...
          while (
            !endTag.test(rest) && !startTagOpen.test(rest) &&
  ...
  function parse(template, options) {
    ...
    parseHTML(template, {
      ...
      chars: function chars(text, start, end) {
        ...
        if (
          isIE && currentParent.tag === "textarea" &&
  ...
  function genCheckboxModel(el, value, modifiers) {
    ...
    addProp(
      el,
      "checked",
      "Array.isArray(" + value + ")" + "?_i(" + value + "," + valueBinding +
        ")>-1" +
    ...
    addHandler(
      el,
      "change",
      "var $$a=" + value + "," + "$$el=$event.target," + "$$c=$$el.checked?(" +
  ...
  function genFor(el, state, altGen, altHelper) {
    ...
    if (
      state.maybeComponent(el) && el.tag !== "slot" && el.tag !== "template" &&
      !el.key
    ) {
      state.warn(
  ...
  function genChildren(el, state, checkSkip, altGenElement, altGenNode) {
    ...
    if (children.length) {
      ...
      if (
        children.length === 1 && el$1.for && el$1.tag !== "template" &&
        el$1.tag !== "slot"
      ) {
  ...
  function genDOMPropSegments(props, attrs) {
    ...
    props.forEach(function (ref) {
      ...
      if (
        isRenderableAttr(name) && !(attrs && attrs.some(function (a) {
          return a.name === name;
        }))
      ) {
  ...
  var prohibitedKeywordRE = new RegExp(
    "\\b" +
      ("do,if,for,let,new,try,var,case,else,with,await,break,catch,class,const," +
        ...
        "extends,finally,continue,debugger,function,arguments").split(",").join(
          "\\b|\\b",
        ) +
      "\\b",
  ...
  var stripStringRE =
    /'(?:[^'\\]|\\.)*'|"(?:[^"\\]|\\.)*"|`(?:[^`\\]|\\.)*\$\{|\}(?:[^`\\]|\\.)*`|`(?:[^`\\]|\\.)*`/g; // detect problematic expressions in a template
    ...
    for (i = 0; i < children.length; i++) {
      ...
      if (Array.isArray(c)) {
        ...
        if (isTextNode(c) && isTextNode(last)) {
          ...
          if (
            isTrue(children._isVList) && isDef(c.tag) && isUndef(c.key) &&
            isDef(nestedIndex)
          ) {
  ...
  function resolveSlots(children, context) {
    ...
    for (var i = 0, l = children.length; i < l; i++) {
      ...
      if (
        (child.context === context || child.fnContext === context) && data &&
        data.slot != null
      ) {
        var name = data.slot;
  ...
  function normalizeScopedSlots(slots, normalSlots, prevSlots) {
    ...
    if (!slots) {
      ...
      isStable && prevSlots && prevSlots !== emptyObject &&
  ...
  function renderStartingTag(node, context) {
    ...
    if (
      isDef(activeInstance) && activeInstance !== node.context &&
  ...
  var TemplateStream =
    ...
    function (Transform) {
      ...
      TemplateStream.prototype = Object.create(
  ...
  var serialize = _npmSerializeJavascript2DewDew();
  ...
  TemplateRenderer.prototype.getPreloadFiles = function getPreloadFiles(
    context,
  ) {
  ...
  TemplateRenderer.prototype.renderScripts = function renderScripts(context) {
    ...
    if (this.clientManifest) {
      ...
      var async = (this.getUsedAsyncFiles(context) || []).filter(
        function (ref) {
          var file = ref.file;
          return isJS(file);
        },
  ...
  TemplateRenderer.prototype.getUsedAsyncFiles = function getUsedAsyncFiles(
    ...
    if (
      !context._mappedFiles && context._registeredComponents && this.mapFiles
    ) {
  ...
  var resolve = _npmResolve1DewDew();

  var NativeModule = _empty;
  ...
  var SourceMapConsumer = _npmSourceMapDew().SourceMapConsumer;
